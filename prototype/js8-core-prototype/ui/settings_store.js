...
(function (root, factory) {
  ...
  const STORAGE_KEY = "ic705.data.prototype.js8-settings";
  ...
  function defaults() {
    return {schemaVersion: SCHEMA_VERSION, activeModem: "js8call",
      ...
      ui: {disclosures: {spectrum: true, reply: true, traffic: true,
